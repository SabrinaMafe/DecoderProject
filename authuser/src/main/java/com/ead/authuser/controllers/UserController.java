...
public class UserController {
    ...
    public ResponseEntity<Page<UserModel>> getAllUsers(SpecificationTemplate.UserSpec spec,
            ...
            sort = "userId", direction = Sort.Direction.ASC)Pageable pageable, @RequestParam(required = false) UUID courseId){
    ...
    @PutMapping("/{userId}/image")  public ResponseEntity<Object> updateImage(@PathVariable(value = "userId")UUID userId,
