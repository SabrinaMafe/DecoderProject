...
public class CourseServiceImpl implements CourseService {
    ...
    @Transactional // caso algo der errado ele volta ao estado anterior
    @Override
    ...
    public void saveSubscriptionUserInCourseAndSendNotification(CourseModel courseModel, UserModel userModel) {
        ...
        try {
            ...
            notificationCommandDto.setMessage(userModel.getFullName() + " a sua inscrição foi realizado com sucesso!");
